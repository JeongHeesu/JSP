...
<form action="/ddit/01/resultParam.jsp" method="POST">
	<table>
		...
		<tr>
			<td> 다섯번째</td>
			<td> <input type="checkbox" name="param_group" value="다셧번째" />
