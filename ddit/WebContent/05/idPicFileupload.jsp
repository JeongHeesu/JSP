...
<!-- 
	http://malsup.com/jquery/form.js
 -->
...
function idPicInput(fileName) {
	...
	$('#idPicForm').ajaxForm({
		...
		success:function(res){
			fileSaveName = res.file_save_name;
				...
				<table width="300" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td height="38" background="../image/open_tt.gif" align="center">
							<form id="idPicForm" action="${pageContext.request.contextPath }/05/idPickFileUpload.jsp" method="post" enctype="maultipart/form-data">
