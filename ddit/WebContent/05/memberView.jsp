...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
 <%
 	//main.jsp <jsp:include page="/05/memberView.jsp?mem_id=a001"/>
...
<body>
<form name="memberViewForm" action="<%=request.getContextPath()%>/05/updateMemberInfo.jsp" method="post">
...
<script type="text/javascript">
	$(function(){
		...
		//삭제
		$('#btn3').click(function(){
<%-- 			$(location).attr('href', '<%=request.getContextPath()%>/05/main.jsp?contentPage=/05/deleteMemberInfo.jsp?mem_id=<%=mem_id%>');			 --%>
		...
		//목록
		$('#btn4').click(function(){
			$(location).attr('href', '<%=request.getContextPath()%>/05/main.jsp?contentPage=/05/memberList.jsp');
		})
