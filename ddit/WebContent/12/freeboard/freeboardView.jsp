	...
	<div class="form-group">
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<c:forEach items="${freeboardInfo.fileItemList }" var="fileItemInfo" varStatus="stat">
				...
				<img alt="pic1" src="/image/${fileItemInfo.file_save_name }" 
				onclick="javascript:location.href='${pageContext.request.contextPath}/12/fileDownload.jsp?fileSeq=${fileItemInfo.file_seq }'"/>
				</div>
			</c:forEach>
